    ...
    <script>
        ...
        $("#quemsomos").on("click", function(){
            $("#principal").fadeOut("slow", function(){
                ...
                $("#principal").html("<h3>O SSMV (Seu Sangue Minha Vida) é uma plataforma que promove uma conexão entre doadores,<br />receptores e hemocentros da sua cidade. Quando o doador ou receptor fazem o cadastro em nosso site,<br />imediatamente podemos conectá-los através de notificações e informações necessárias para localizarem<br />o hospital ou hemocentro mais próximo. Uma Iniciativa com objetivo de salvar vidas conectando pessoas com este mesmo objetivo.<br />O SSMV foi criado na cidade de Alegrete, no Rio Grande do Sul, por alunos de Engenharia de Software da UNIPAMPA.</h3>");
                if($.cookie("acessibilidade") == "TRUE"){
                    acessibilidade("SIM");
                }
                $("#principal").fadeIn("slow");
