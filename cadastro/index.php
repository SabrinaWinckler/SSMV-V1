<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" class="gr__codefeed_in_iis2103_shared-servers_com"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="/cdn/fonts/font-awesome/css/font-awesome.min.css" rel="stylesheet">
            ...
            <div class="span10 offset1">
                ...
                <div class="tabbable custom-tabs tabs-animated  flat flat-all hide-label-980 shadow track-url auto-scroll">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#panel1" data-toggle="tab"><i class="icon-lock"></i>&nbsp;<span>Login Panel</span></a></li>
                        ...
                        <div class="tab-pane active" id="panel1">
                            <div class="row-fluid">
                                <div class="span5">
                                    ...
                                    <a href="l#" class=" btn  ">Sign In&nbsp;&nbsp;&nbsp;<i class="icon-chevron-sign-right"></i></a>
                                </div>
                                <div class="span3">
