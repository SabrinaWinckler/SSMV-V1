	...
	<div class="ajuda">
		...
		<button id="myBtn">Como Realizar o Cadastro?</button>
					...
					<div class="modal-body">
						<p>Para se cadastrar é necessário possuir um e-mail válido ou uma conta ativada no facebook. Tendo um dos dois você acessa a página inicial clicando no ícone do site e clica no botão "Cadastro". Depois é só preencher os devidos campos com seus dados e avançar as seções, conferir seus dados, se houver algum erro você pode voltar as seções até concluir o cadastro.</p>
					</div>
		...
		<button id="myBtn1">Como Realizar Doa��o?</button>
			...
			<span1 class="close">&times;</span1>
				...
				<div class="modal-body">
					<p>Para doar você precisa estar logado e autenticado no sistema, após isto, clique na aba do canto direito "Quero doar". O site procura o hemocentro mais próximo de você e a partir daí você marca um horário no hemocentro de sua preferência.</p>
				</div>
					<div class="modal-footer">
						<h2>Continua com d�vida ou n�o consegue realizar alguma das etapas?<br>Entre em contato conosco!</h2>
					</div>
